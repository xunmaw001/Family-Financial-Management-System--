<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总收入" prop="zongshouru">
          <el-input v-model="ruleForm.zongshouru" 
              placeholder="总收入" clearable  :readonly="ro.zongshouru"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="总收入" prop="zongshouru">
              <el-input v-model="ruleForm.zongshouru" 
                placeholder="总收入" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总支出" prop="zongzhichu">
          <el-input v-model="ruleForm.zongzhichu" 
              placeholder="总支出" clearable  :readonly="ro.zongzhichu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="总支出" prop="zongzhichu">
              <el-input v-model="ruleForm.zongzhichu" 
                placeholder="总支出" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='zongshouru'){
            this.ruleForm.zongshouru = obj[o];
	    this.ro.zongshouru = true;
            continue;
          }
          if(o=='zongzhichu'){
            this.ruleForm.zongzhichu = obj[o];
	    this.ro.zongzhichu = true;
            continue;
          }
          if(o=='zhaopian'){
    ...
    info(id) {
      this.$http({
        url: `jiatingniandushouzhi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiatingniandushouzhi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiatingniandushouzhiCrossAddOrUpdateFlag = false;
                  this.parent.search();
