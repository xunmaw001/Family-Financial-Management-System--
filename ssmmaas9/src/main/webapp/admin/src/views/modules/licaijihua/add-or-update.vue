<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="理财规划" prop="licaiguihua">
          <el-input v-model="ruleForm.licaiguihua" 
              placeholder="理财规划" clearable  :readonly="ro.licaiguihua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="理财规划" prop="licaiguihua">
              <el-input v-model="ruleForm.licaiguihua" 
                placeholder="理财规划" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="余额" prop="yue">
            <el-input v-model="yue"
                placeholder="余额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yue" label="余额" prop="yue">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="余额状态" prop="yuezhuangtai">
          <el-select v-model="ruleForm.yuezhuangtai" placeholder="请选择余额状态">
            <el-option
                v-for="(item,index) in yuezhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="余额状态" prop="yuezhuangtai">
	      <el-input v-model="ruleForm.yuezhuangtai"
                placeholder="余额状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="收入项目" prop="shouruxiangmu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shouruxiangmu" label="收入项目" prop="shouruxiangmu">
                    <span v-html="ruleForm.shouruxiangmu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="支出项目" prop="zhichuxiangmu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhichuxiangmu" label="支出项目" prop="zhichuxiangmu">
                    <span v-html="ruleForm.zhichuxiangmu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shouruxiangmu = this.ruleForm.shouruxiangmu.replace(reg,'../../../ssmmaas9/upload');
	this.ruleForm.zhichuxiangmu = this.ruleForm.zhichuxiangmu.replace(reg,'../../../ssmmaas9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
