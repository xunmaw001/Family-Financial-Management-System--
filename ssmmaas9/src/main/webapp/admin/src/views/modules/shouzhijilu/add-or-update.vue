<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="当前状态" prop="dangqianzhuangtai">
          <el-select v-model="ruleForm.dangqianzhuangtai" placeholder="请选择当前状态">
            <el-option
                v-for="(item,index) in dangqianzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="交易金额" prop="jiaoyijine">
          <el-input v-model="ruleForm.jiaoyijine" 
              placeholder="交易金额" clearable  :readonly="ro.jiaoyijine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="交易金额" prop="jiaoyijine">
              <el-input v-model="ruleForm.jiaoyijine" 
                placeholder="交易金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收支方式" prop="shouzhifangshi">
          <el-input v-model="ruleForm.shouzhifangshi" 
              placeholder="收支方式" clearable  :readonly="ro.shouzhifangshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收支方式" prop="shouzhifangshi">
              <el-input v-model="ruleForm.shouzhifangshi" 
                placeholder="收支方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="交易单号" prop="jiaoyidanhao">
          <el-input v-model="ruleForm.jiaoyidanhao" 
              placeholder="交易单号" clearable  :readonly="ro.jiaoyidanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="交易单号" prop="jiaoyidanhao">
              <el-input v-model="ruleForm.jiaoyidanhao" 
                placeholder="交易单号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户单号" prop="shanghudanhao">
          <el-input v-model="ruleForm.shanghudanhao" 
              placeholder="商户单号" clearable  :readonly="ro.shanghudanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户单号" prop="shanghudanhao">
              <el-input v-model="ruleForm.shanghudanhao" 
                placeholder="商户单号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dangqianzhuangtai = true;
          ...
          if(o=='jiaoyijine'){
            this.ruleForm.jiaoyijine = obj[o];
	    this.ro.jiaoyijine = true;
            continue;
          }
          if(o=='shijian'){
	    ...
	    this.ro.shijian = true;
          ...
          if(o=='shouzhifangshi'){
            this.ruleForm.shouzhifangshi = obj[o];
	    this.ro.shouzhifangshi = true;
            continue;
          }
          if(o=='jiaoyidanhao'){
            this.ruleForm.jiaoyidanhao = obj[o];
	    this.ro.jiaoyidanhao = true;
            continue;
          }
          if(o=='shanghudanhao'){
            this.ruleForm.shanghudanhao = obj[o];
	    this.ro.shanghudanhao = true;
            continue;
          }
          if(o=='zhaopian'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.dangqianzhuangtaiOptions = "收款成功,支付成功".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `shouzhijilu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../ssmmaas9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shouzhijilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shouzhijiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
