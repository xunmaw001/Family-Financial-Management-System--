		...
		<view class="container">
				...
				<swiper-item v-for="(swiper,index) in swiperList" :key="index">
					...
					<view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.xingbie}}</view>
                				                				...
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 00px rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"rgba(0, 204, 0, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(0, 204, 0, 1)","textAlign":"left"}'>年龄：</view>
					...
					<view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.shouji}}</view>
                				                				...
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 00px rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"rgba(0, 204, 0, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(0, 204, 0, 1)","textAlign":"left"}'>身份证：</view>
